...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        My names Niki Mortazavi and i'm a web developer based in South Africa. I
        enjoy working with JavaScript frameworks such as react.js, node.js,
        etc..
        <br />
        ...
        would welcome the chance to join a team and dedicate myself full-time to
